        ...
        <div class="wrapper">
                ...
                <table class="tbl-40">
                    ...
                    <tr>
                        <td>
                            ...
                            <input type="submit" name="submit" class="btn-sussces" value="Update">
                        </td>
                    </tr>
                </table>
            </form>
            <?php 
                if(isset($_POST['submit']))
                {
                    ...
                    if(isset($_FILES['image']['name']))
                    {
                        ...
                        if($image_name != "")
                        {
                            ...
                            if($current_image != "")
                            {
                                ...
                                if($remove == FALSE)
                                {
                                    $_SESSION['remove-falied'] = "<div class='error'>Failed to remove current image.!</div>";
                                    header('location:'.SITEURL.'admin/mananger-food.php');
                                    die();
                                }
                            }
                    ...
                    if($res3 == TRUE)
                    {
                        $_SESSION['update'] ="<div class='sussces'>Food Updated Susscesfully.!</div>";
                        header('location:'.SITEURL.'admin/mananger-food.php');
                    }
                    else
                    {
