    ...
    <div class="main-content">
        <div class="wrapper">
            ...
            <?php
                ...
                if(isset($_SESSION['remove-falied']))
                {
                    echo $_SESSION['remove-falied'];
                    unset($_SESSION['remove-falied']);
                }
            ?>
                        ...
                        while($row = mysqli_fetch_assoc($res))
                        {
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo SITEURL; ?>admin/update-food.php?id=<?php echo $id?>" class="btn-sussces">Update</a> 
